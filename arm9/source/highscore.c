...
void highscore_showoptions(u16 options)
{
    ...
    {
        dsPrintValue(22,4,0, (char*)"[LOWSC]");
    }
    else if ((options & HS_OPT_SORTMASK) == HS_OPT_SORTTIME)
    {
        dsPrintValue(22,4,0, (char*)"[TIME] ");
    }
    else if ((options & HS_OPT_SORTMASK) == HS_OPT_SORTASCII)
    {
        dsPrintValue(22,4,0, (char*)"[ALPHA]");
    }
    else
    {   
        dsPrintValue(22,4,0, (char*)"       ");    
    }
}
...
{
    dsPrintValue(3,4,0, (char*)highscores.highscore_table[foundIdx].notes);
    for (int i=0; i<10; i++)
    {
        ...
        dsPrintValue(3,5+i, 0, hs_line);
    }
    
    if (bShowLegend)
    {
        dsPrintValue(2,14,0, (char*)"                             ");
        dsPrintValue(2,17,0, (char*)"PRESS X FOR NEW HI SCORE     ");
        dsPrintValue(2,18,0, (char*)"PRESS Y FOR NOTES/OPTIONS    ");
        dsPrintValue(2,19,0, (char*)"PRESS B TO EXIT              ");
        dsPrintValue(2,20,0, (char*)"SCORES AUTO SORT AFTER ENTRY ");
    }
...
void highscore_entry(short foundIdx, u32 crc)
{
    ...
    dsPrintValue(2,18,0, (char*)"UP/DN/LEFT/RIGHT ENTER SCORE");
    dsPrintValue(2,19,0, (char*)"PRESS START TO SAVE SCORE   ");
    dsPrintValue(2,20,0, (char*)"PRESS SELECT TO CANCEL      ");
    dsPrintValue(2,21,0, (char*)"                            ");
...
void highscore_options(short foundIdx, u32 crc)
{
    ...
    dsPrintValue(3,15,0, (char*)"NOTE: ");
    dsPrintValue(3,18,0, (char*)"UP/DN/LEFT/RIGHT ENTER NOTES");
    dsPrintValue(3,19,0, (char*)"X=TOGGLE SORT, L+R=CLR SCORE");
    dsPrintValue(3,20,0, (char*)"PRESS START TO SAVE OPTIONS ");
    dsPrintValue(3,21,0, (char*)"PRESS SELECT TO CANCEL      ");
    ...
    while (!bEntryDone)
    {
        ...
        dsPrintValue(9,15, 0, (char*)hs_line);
    }
